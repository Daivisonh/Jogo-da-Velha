...
class Forca(Frame):
    ...
    def set_letras_digitadas(self, letras):
        ...
        if "_" not in self.palavra_secreta:
            messagebox.showinfo("Exelente","Parabéns você acertou a palavra secreta\n{}".format(self.palavra))
    ...
    def create_widgets(self):
        ...
        self.letraA = Button(self.frame1, font=("Helvetica", 12), text="A", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("A"))
        self.letraA.grid(row=0, column=0, sticky="NWNESWSE")

        self.letraÁ = Button(self.frame1, font=("Helvetica", 12), text="Á", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Á"))
        self.letraÁ.grid(row=0, column=1, sticky="NWNESWSE")

        self.letraÂ = Button(self.frame1, font=("Helvetica", 12), text="Â", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Â"))
        self.letraÂ.grid(row=0, column=2, sticky="NWNESWSE")

        self.letraÃ = Button(self.frame1, font=("Helvetica", 12), text="Ã", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ã"))
        self.letraÃ.grid(row=0, column=3, sticky="NWNESWSE")
        ...
        self.letraB.grid(row=0, column=4, sticky="NWNESWSE")

        self.letraC = Button(self.frame1, font=("Helvetica", 12), text="C", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("C"))
        self.letraC.grid(row=0, column=5, sticky="NWNESWSE")

        self.letraÇ = Button(self.frame1, font=("Helvetica", 12), text="Ç", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ç"))
        self.letraÇ.grid(row=0, column=6, sticky="NWNESWSE")
        ...
        self.letraD.grid(row=0, column=7, sticky="NWNESWSE")

        self.letraE = Button(self.frame1, font=("Helvetica", 12), text="E", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("E"))
        self.letraE.grid(row=0, column=8, sticky="NWNESWSE")

        self.letraÉ = Button(self.frame1, font=("Helvetica", 12), text="É", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("É"))
        self.letraÉ.grid(row=0, column=9, sticky="NWNESWSE")

        self.letraÊ = Button(self.frame1, font=("Helvetica", 12), text="Ê", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ê"))
        self.letraÊ.grid(row=0, column=10, sticky="NWNESWSE")
        ...
        self.letraF.grid(row=0, column=11, sticky="NWNESWSE")
        ...
        self.letraG.grid(row=0, column=12, sticky="NWNESWSE")
        ...
        self.letraI = Button(self.frame1, font=("Helvetica", 12), text="I", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("I"))
        self.letraI.grid(row=1, column=1, sticky="NWNESWSE")

        self.letraI = Button(self.frame1, font=("Helvetica", 12), text="I", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Í"))
        self.letraI.grid(row=1, column=2, sticky="NWNESWSE")
        ...
        self.letraJ.grid(row=1, column=3, sticky="NWNESWSE")
        ...
        self.letraK.grid(row=1, column=4, sticky="NWNESWSE")
        ...
        self.letraL.grid(row=1, column=5, sticky="NWNESWSE")
        ...
        self.letraM.grid(row=1, column=6, sticky="NWNESWSE")
        ...
        self.letraN.grid(row=1, column=7, sticky="NWNESWSE")

        #linha 2
        self.letraO = Button(self.frame1, font=("Helvetica", 12), text="O", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("O"))
        self.letraO.grid(row=2, column=0, sticky="NWNESWSE")

        self.letraÓ = Button(self.frame1, font=("Helvetica", 12), text="Ó", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ó"))
        self.letraÓ.grid(row=2, column=1, sticky="NWNESWSE")

        self.letraÔ = Button(self.frame1, font=("Helvetica", 12), text="Ô", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ô"))
        self.letraÔ.grid(row=2, column=2, sticky="NWNESWSE")
        ...
        self.letraP.grid(row=2, column=3, sticky="NWNESWSE")
        ...
        self.letraQ.grid(row=2, column=4, sticky="NWNESWSE")
        ...
        self.letraR.grid(row=2, column=5, sticky="NWNESWSE")
        ...
        self.letraS.grid(row=2, column=6, sticky="NWNESWSE")
        ...
        self.letraT.grid(row=2, column=7, sticky="NWNESWSE")

        self.letraU = Button(self.frame1, font=("Helvetica", 12), text="U", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("U"))
        self.letraU.grid(row=2, column=8, sticky="NWNESWSE")

        self.letraÚ = Button(self.frame1, font=("Helvetica", 12), text="Ú", borderwidth=1,padx=16, pady=16, command=lambda: self.set_letras_digitadas("Ú"))
        self.letraÚ.grid(row=2, column=9, sticky="NWNESWSE")
...
forca = Tk()
forca.title("Palavra Secreta Ver. {}".format(TkVersion))
forca.resizable(0, 0)
